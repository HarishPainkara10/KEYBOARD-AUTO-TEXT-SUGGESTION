...
with open(r"D:\Keyboard-Auto-Suggestion-NLP-Python-Project-main\Keyboard-Auto-Suggestion-NLP-Python-Project-main\autocorrect book.txt", encoding='utf-8') as f:
    data = f.read().lower()
